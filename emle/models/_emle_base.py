...
class EMLEBase(_torch.nn.Module):
    ...
    def cuda(self, **kwargs):
        ...
        self.c6_Z = _torch.nn.Parameter(self.c6_Z.cuda(**kwargs))
    ...
    def cpu(self, **kwargs):
        ...
        self.c6_Z = _torch.nn.Parameter(self.c6_Z.cpu(**kwargs))
    ...
    def double(self):
        ...
        self.c6_Z = _torch.nn.Parameter(self.c6_Z.double())
    ...
    def float(self):
        ...
        self.c6_Z = _torch.nn.Parameter(self.c6_Z.float())
    ...
    def _gpr(self, mol_features, ref_mean, c, zid, return_var=False):
        """
        ...
        return_var: bool
            Whether to return the variance of the prediction.
